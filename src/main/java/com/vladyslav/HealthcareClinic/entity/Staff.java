...
public class Staff {
    ...
    private String specialisation; // e.g., Radiologist, Doctor
    ...
    private List<Task> tasks; //Tasks created by this staff member

    @OneToMany(mappedBy = "staff", cascade = CascadeType.ALL)
    private List<Image> images; //Tasks created by this staff member
